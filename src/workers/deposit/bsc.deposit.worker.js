...
import { BscClient } from '../../chains/bsc/bsc.client.js';
import { BscERC20Parser } from '../../chains/bsc/bsc.erc20.parser.js';
...
export class BscDepositWorker {
    ...
    async processAssetDeposits(asset, fromBlock, toBlock) {
        ...
        try {
            ...
            const transfers = await this.bscClient.getERC20Transfers(asset.contract_address, fromBlock, toBlock);
            logger.debug({
    ...
    async processDeposit(deposit, asset, userAddress) {
        ...
        try {
            ...
            const amountHuman = BscERC20Parser.calculateHumanAmount(deposit.amountRaw, asset.decimals);
...
//# sourceMappingURL=bsc.deposit.worker.js.map